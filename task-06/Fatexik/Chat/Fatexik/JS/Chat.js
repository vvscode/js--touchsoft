...
Module = (function chat(userConfigObj) {
    ...
    XHRObject.prototype.getLongPoolingMessages = function getMessages() {
        var xhr = new XMLHttpRequest();
    ...
    function generateCollapsedFeedback() {
        ...
        collapsedFeedback.innerHTML ='@@import collapsedFeedback.html';
    ...
    function generateFeedback() {
        ...
        container.innerHTML ='@@import feedback.html';
        return container;
    }
